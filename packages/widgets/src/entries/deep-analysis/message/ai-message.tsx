...
import { AIAnalysisMessageComponent } from "./analysis-message";
import { DataAnalysisMessage } from "./model";
...
export function AIMessageComponent({
  ...
  if (message instanceof DataAnalysisMessage) {
    return <AIAnalysisMessageComponent message={message} loading={loading} />;
  }
